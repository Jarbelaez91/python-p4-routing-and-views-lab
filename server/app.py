...
#Your index() view should be routed to at the base URL with /. It should Contain an h1 element that contains the title of this application, 
...
#A print_string view should take one parameter, a string. It should print the string in the terminal and display it in the web browser. 
